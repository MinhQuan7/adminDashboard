      ...
      connectors: [
        {
          ...
          options: {
            ...
            dataUrl:
              "https://demo-live-data.highcharts.com/instance-details.json",
            beforeParse: function (data) {
              const currentInstance =
                data.find((inst) => inst.InstanceId === currentInstanceId) ||
                data;
              return currentInstance.Details.map((el) => el);
            }
          }
        },
        {
      ...
      },
      {
        ...
        chartOptions: {
          ...
          lang: {
            accessibility: {
              chartContainerLabel:
                "Disk usage. Highcharts " + "interactive chart."
            }
          },
          accessibility: {
      ...
      },
      {
        ...
        chartOptions: {
          ...
          lang: {
            accessibility: {
              chartContainerLabel:
                "CPU usage. Highcharts " + "interactive chart."
            }
          },
          tooltip: {
            valueSuffix: "%"
      ...
      },
      {
        ...
        chartOptions: {
          ...
          lang: {
            accessibility: {
              chartContainerLabel:
                "Memory usage. Highcharts " + "interactive chart."
            }
          },
          tooltip: {
            valueSuffix: " MB"
        ...
        chartOptions: {
          ...
          legend: {
            labelFormatter: function () {
              const result = this.name.replace(/([A-Z])/g, " $1").toLowerCase();
          ...
          events: {
            row: {
              click: async function (e) {
                ...
                board.destroy();
                setupDashboard(e.target.parentNode.childNodes[0].innerText);
